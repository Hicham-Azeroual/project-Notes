...
@extends('layouat.app-header')
  ...
  <main id="main" class="main">
    ...
    <section class="section">
                ...
                <table class="table table-striped table-hover" style="align-items: center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $module->name }}</td>
                            <td>
                                <a href="#editModuleModal{{ $module->id }}" class="edit" data-toggle="modal">
                                    <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                </a>
                                <a href="#deleteModuleModal{{ $module->id }}" class="delete" data-toggle="modal">
        ...
        <!-- Edit Modal HTML -->
        <div id="editModuleModal{{ $module->id }}" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        <div class="modal-header">
        ...
        <!-- Delete Modal HTML -->
        <div id="deleteEmployeeModal{{ $module->id }}" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        <div class="modal-header">
